...
# --- SELECCIÓN DEL MODELO A REFINAR ---
BATCH_SIZE_USED = 5
MODEL_ID_TO_REFINE = 1  # <--- CAMBIA ESTO POR EL ID DEL MEJOR MODELO OBTENIDO

# Construir ruta dinámica al modelo ganador
INPUT_MODEL_DIR = os.path.join(CARPETA_FILES, str(BATCH_SIZE_USED), str(MODEL_ID_TO_REFINE))
INPUT_JSON_PATH = os.path.join(INPUT_MODEL_DIR, "sindy_training_params.json")

# Salida (El resultado refinado)
OUTPUT_DIR = os.path.join(INPUT_MODEL_DIR, "fine_tuning") 
